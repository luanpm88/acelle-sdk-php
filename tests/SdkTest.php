...
final class SdkTest extends TestCase
{
    public function getClient() {
        return new \Acelle\Client('http://acelle.com/api/v1', 'WaiUJxQyWwXECLrX7Hk1E7fT1mi705qWSSp5P1D00v7lyTeus9QWQ6SVM5jn');
    }
    ...
    public function testSubscriberFind() {
        ...
        $this->assertIsArray($this->getClient()->subscriber()->find($subscriber['id']));
    }
    ...
    public function testSubscriberUpdate() {
        $subscriber = $this->pickASubscriber();
        $this->assertIsArray($this->getClient()->subscriber()->update($subscriber['id'], [
    ...
    //     $subscriber = $this->pickASubscriber();
    //     $this->assertIsArray($this->getClient()->subscriber()->subscribe($subscriber['id']));
    // }

    // public function testSubscriberUnsubscribe() {
    //     $subscriber = $this->pickASubscriber();
    //     $this->assertIsArray($this->getClient()->subscriber()->unsubscribe($subscriber['id']));
    // }

    public function testSubscriberDelete() {
        $subscriber = $this->pickASubscriber();
        $this->assertIsArray($this->getClient()->subscriber()->delete($subscriber['id']));
    }
